...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>TRUNCATE Function</h2>
    <h3>Description</h3>
    <p>The <code>TRUNCATE()</code> function returns a number truncated to a specified number of decimal places.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, CEIL(Salary) AS result FROM employee WHERE ID = 3 LIMIT 20";
