  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>TRUNCATE Function</h2>
        <h3>Description</h3>
        <p>The TRUNCATE() function returns a number truncated to a specified number of decimal places.</p>
        <h3>Syntax</h3>
        <pre><code>TRUNCATE(number, decimal_places)</code></pre>
        <h3>Parameter Values</h3>
        <ul style="color: #e6eef3;"><li>number: The number to truncate.</li><li>decimal_places: The number of decimal places to truncate to.</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT TRUNCATE(12.3456789, 2) as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
