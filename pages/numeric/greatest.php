...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>GREATEST Function</h2>
    <h3>Description</h3>
    <p>The <code>GREATEST()</code> function returns the greatest value from a list of values.</p>
    <h3>Syntax</h3>
    <pre><code>GREATEST(value1, value2, ...)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The greatest value from the list of values.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, GREATEST(Salary, 50000) AS result FROM employee LIMIT 20";
