  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>GREATEST Function</h2>
        <h3>Description</h3>
        <p>The GREATEST() function returns the greatest value from a list of values.

If any argument is NULL, the GREATEST() function returns NULL.</p>
        <h3>Syntax</h3>
        <pre><code>GREATEST(value1, value2, ...)</code></pre>
        <h3>Parameter Values</h3>
        <ul style="color: #e6eef3;"><li>value1, value2, ...: The values to compare</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT GREATEST(10, 20, 30) as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
