...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>TAN Function</h2>
    <h3>Description</h3>
    <p>The <code>TAN()</code> function returns the tangent of a number in radians.</p>
    <h3>Syntax</h3>
    <pre><code>TAN(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The tangent of the specified number in radians.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, TAN(Salary) AS result FROM employee LIMIT 20";
