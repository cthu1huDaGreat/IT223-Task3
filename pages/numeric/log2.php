...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>LOG2 Function</h2>
    <h3>Description</h3>
    <p>The <code>LOG2()</code> function returns the base-2 logarithm of a number.</p>
    <h3>Syntax</h3>
    <pre><code>LOG2(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The base-2 logarithm of the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, LOG2(Salary) AS result FROM employee LIMIT 20";
