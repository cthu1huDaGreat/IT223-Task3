...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>ROUND Function</h2>
    <h3>Description</h3>
    <p>The <code>ROUND()</code> function rounds a number to a specified number of decimal places.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, ROUND(Salary, 4) AS result FROM employee LIMIT 20";
