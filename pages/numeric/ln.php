...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>LN Function</h2>
    <h3>Description</h3>
    <p>The <code>LN()</code> function returns the natural logarithm of a number.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, LN(Salary) AS result FROM employee LIMIT 20";
