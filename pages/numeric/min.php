...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>MIN Function</h2>
    <h3>Description</h3>
    <p>The <code>MIN()</code> function returns the minimum value in a set of values.</p>
    <h3>Syntax</h3>
    <pre><code>MIN(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The smallest value in a set of numbers.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, MIN(Salary) AS result FROM employee LIMIT 20";
