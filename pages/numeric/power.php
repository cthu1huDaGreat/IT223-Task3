...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>POWER Function</h2>
    <h3>Description</h3>
    <p>The <code>POWER()</code> function returns the value of a number raised to a power.</p>
    <h3>Syntax</h3>
    <pre><code>POWER(number, power)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The value of a number raised to a power.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, POWER(Salary, 2) AS result FROM employee LIMIT 20";
