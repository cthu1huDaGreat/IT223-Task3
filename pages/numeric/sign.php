...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>SIGN Function</h2>
    <h3>Description</h3>
    <p>The <code>SIGN()</code> function returns the sign of a number: 1 for positive, -1 for negative, and 0 for zero.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, SIGN(Salary) AS result FROM employee LIMIT 20";
