...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>COUNT Function</h2>
    <h3>Description</h3>
    <p>The <code>COUNT()</code> function returns the number of rows in a table.</p>
    <p>The COUNT() function is often used with a WHERE clause to count only specific rows.</p>
    <h3>Syntax</h3>
    <pre><code>COUNT(column_name)</code></pre>
    <h3>Parameter Values</h3>
    <ul style="color: #e6eef3;">
      <li>column_name: The column to count rows in</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, COUNT(Salary) AS result FROM employee LIMIT 20";
