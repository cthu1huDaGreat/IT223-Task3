...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>RAND Function</h2>
    <h3>Description</h3>
    <p>The <code>RAND()</code> function returns a random floating-point value between 0 and 1.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, RAND() AS result FROM employee LIMIT 20";
