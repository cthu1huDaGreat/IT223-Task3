...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>DEGREES Function</h2>
    <h3>Description</h3>
    <p>The <code>DEGREES()</code> function converts a value in radians to degrees.</p>
    <h3>Syntax</h3>
    <pre><code>DEGREES(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The value in degrees.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, DEGREES(Salary) AS result FROM employee LIMIT 20";
