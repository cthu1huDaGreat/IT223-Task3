  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>DEGREES Function</h2>
        <h3>Description</h3>
        <p>The DEGREES() function converts a value in radians to degrees.

The specified number must be between -1 to 1, otherwise this function returns NULL. </p>
        <h3>Syntax</h3>
        <pre><code>DEGREES(number)</code></pre>
        <h3>Parameter Values</h3>
        <ul style="color: #e6eef3;"><li>number: The number in radians to be converted to degrees</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT DEGREES(1) as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
