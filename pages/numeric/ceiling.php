...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>CEILING Function</h2>
    <h3>Description</h3>
    <p>The <code>CEILING()</code> function returns the smallest integer value that is greater than or equal to a number.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, CEILING(Salary) AS result FROM employee LIMIT 20";
