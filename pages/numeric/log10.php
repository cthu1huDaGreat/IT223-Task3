...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>LOG10 Function</h2>
    <h3>Description</h3>
    <p>The <code>LOG10()</code> function returns the base-10 logarithm of a number.</p>
    <h3>Syntax</h3>
    <pre><code>LOG10(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The base-10 logarithm of the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, LOG10(Salary) AS result FROM employee LIMIT 20";
