...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>CEIL Function</h2>
    <h3>Description</h3>
    <p>The <code>CEIL()</code> function returns the smallest integer value that is greater than or equal to a number.</p>
    <h3>Syntax</h3>
    <pre><code>CEIL(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The smallest integer value that is greater than or equal to the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, CEIL(Salary) AS result FROM employee LIMIT 20";
