...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>MOD Function</h2>
    <h3>Description</h3>
    <p>The <code>MOD()</code> function returns the remainder of a division operation.</p>
    <h3>Syntax</h3>
    <pre><code>MOD(number1, number2)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The remainder of the division operation.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, MOD(Salary, 1000) AS result FROM employee LIMIT 20";
