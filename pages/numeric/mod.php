  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>MOD Function</h2>
        <h3>Description</h3>
        <p>The MOD() function returns the remainder of a division operation.

The specified number must be greater than 0, otherwise this function returns NULL. </p>
        <h3>Syntax</h3>
        <pre><code>MOD(number1, number2)</code></pre>
        <h3>Parameter Values</h3>
        <ul style="color: #e6eef3;"><li>number1: The number to be divided</li><li>number2: The number to divide by</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT MOD(10, 3) as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
