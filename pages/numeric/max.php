...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>MAX Function</h2>
    <h3>Description</h3>
    <p>The <code>MAX()</code> function returns the maximum value in a set of values.</p>
    <h3>Syntax</h3>
    <pre><code>MAX(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The maximum value in a set of values.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, MAX(Salary) AS result FROM employee LIMIT 20";
