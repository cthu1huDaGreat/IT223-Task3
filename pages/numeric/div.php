  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i> DIV Function</h2>
        <h3>Description</h3>
        <p>The DIV function performs integer division of two numbers.

The result is the quotient of the division, truncated to an integer. </p>
        <h3>Syntax</h3>
        <pre><code>number1 DIV number2</code></pre>
        <h3>Parameter Values</h3>
        <ul style="color: #e6eef3;"><li>number1: The dividend</li><li>number2: The divisor</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT 10 DIV 3 as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
