  ...
  <div class="page-content">
    <div class="container-fluid p-5">
      <div class="function-card">
        ...
        <h3>Description</h3>
        <p>The <code>ACOS()</code> function returns the arc cosine of a number. The specified number must be between -1 to 1, otherwise this function returns NULL.</p>
        <h3>Syntax</h3>
        <pre><code>ACOS(number)</code></pre>
        <h3>Returns</h3>
        <ul style="color: #e6eef3;"><li>Arc cosine of a number:</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php 
            include "../../config.php"; 
            $result = $conn->query("SELECT Salary, ACOS(Salary) as result FROM employee WHERE ID = 3 LIMIT 1");
