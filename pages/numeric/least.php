...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>LEAST Function</h2>
    <h3>Description</h3>
    <p>The <code>LEAST()</code> function returns the smallest value from a list of values.
If any argument is NULL, the LEAST() function returns NULL.</p>
    <h3>Syntax</h3>
    <pre><code>LEAST(value1, value2, ...)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The smallest value from a list of values.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, LEAST(Salary, 50000) AS result FROM employee LIMIT 20";
