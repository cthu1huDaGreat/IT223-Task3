  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>LEAST Function</h2>
        <h3>Description</h3>
        <p>The LEAST() function returns the smallest value from a list of values.

If any argument is NULL, the LEAST() function returns NULL.</p>
        <h3>Syntax</h3>
        <pre><code>LEAST(value1, value2, ...)</code></pre>
      ...
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT LEAST(10, 20, 30) as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
