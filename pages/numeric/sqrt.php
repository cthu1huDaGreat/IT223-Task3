...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>SQRT Function</h2>
    <h3>Description</h3>
    ...
    <ul style="color: #e6eef3;">
      <li>The square root of the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, SQRT(Salary) AS result FROM employee LIMIT 20";
