...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>EXP Function</h2>
    <h3>Description</h3>
    <p>The <code>EXP()</code> function returns the exponential value of a number.</p>
    <h3>Syntax</h3>
    <pre><code>EXP(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The exponential value of the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, EXP(Salary) AS result FROM employee WHERE ID = 3 LIMIT 20";
