  ...
  <div class="page-content">
    <div class="container-fluid p-5">
      <div class="function-card">
        ...
        <h3>Description</h3>
        <p>The <code>ATAN()</code> function returns the arc tangent of a number. </p>
        <h3>Syntax</h3>
      ...
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            ...
            $result = $conn->query("SELECT Salary, ATAN(Salary) as result FROM employee WHERE ID = 3 LIMIT 1"); 
