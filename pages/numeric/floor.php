...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>FLOOR Function</h2>
    <h3>Description</h3>
    <p>The <code>FLOOR()</code> function returns the largest integer value that is less than or equal to a number.</p>
    <h3>Syntax</h3>
    <pre><code>FLOOR(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The largest integer value that is less than or equal to the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, FLOOR(Salary) AS result FROM employee LIMIT 20";
