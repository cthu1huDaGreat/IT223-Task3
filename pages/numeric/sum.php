...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>SUM Function</h2>
    <h3>Description</h3>
    <p>The <code>SUM()</code> function returns the sum of a set of values.</p>
    <h3>Syntax</h3>
    <pre><code>SUM(expression)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The sum of the values in the specified expression.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, SUM(Salary) AS result FROM employee LIMIT 20";
