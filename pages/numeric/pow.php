...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>POW Function</h2>
    <h3>Description</h3>
    <p>The <code>POW()</code> function returns the value of a number raised to a power.</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, POW(Salary, 2) AS result FROM employee LIMIT 20";
