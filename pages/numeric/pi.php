  ...
  <div class="page-content">
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>PI Function</h2>
        <h3>Description</h3>
        <p>The PI() function returns the value of π (pi).</p>
        <h3>Syntax</h3>
      ...
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT PI() as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
