...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-calculator me-2"></i>PI Function</h2>
    <h3>Description</h3>
    <p>The <code>PI()</code> function returns the value of π (pi).</p>
    <h3>Syntax</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, PI() AS result FROM employee LIMIT 1";
