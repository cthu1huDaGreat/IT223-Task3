...
<body>
  ...
  <a class="nav-link py-1" href="/IT223-task3/pages/string/upper.php">UPPER</a>
      ...
      <div class="collapse ps-3" id="numericFunctions" data-bs-parent="#sidebar">
        <a class="nav-link py-1" href="abs.php">ABS</a>
        <a class="nav-link py-1" href="acos.php">ACOS</a>
        <a class="nav-link py-1" href="asin.php">ASIN</a>
        <a class="nav-link py-1" href="atan.php">ATAN</a>
        <a class="nav-link py-1" href="atan2.php">ATAN2</a>
        <a class="nav-link py-1" href="avg.php">AVG</a>
        <a class="nav-link py-1" href="ceil.php">CEIL</a>
        <a class="nav-link py-1" href="ceiling.php">CEILING</a>
        <a class="nav-link py-1" href="cos.php">COS</a>
        <a class="nav-link py-1" href="cot.php">COT</a>
        <a class="nav-link py-1" href="count.php">COUNT</a>
        <a class="nav-link py-1" href="degrees.php">DEGREES</a>
        <a class="nav-link py-1" href="div.php">DIV</a>
        <a class="nav-link py-1" href="exp.php">EXP</a>
        <a class="nav-link py-1" href="floor.php">FLOOR</a>
        <a class="nav-link py-1" href="greatest.php">GREATEST</a>
        <a class="nav-link py-1" href="least.php">LEAST</a>
        <a class="nav-link py-1" href="ln.php">LN</a>
        <a class="nav-link py-1" href="log.php">LOG</a>
        <a class="nav-link py-1" href="log10.php">LOG10</a>
        <a class="nav-link py-1" href="log2.php">LOG2</a>
        <a class="nav-link py-1" href="max.php">MAX</a>
        <a class="nav-link py-1" href="min.php">MIN</a>
        <a class="nav-link py-1" href="mod.php">MOD</a>
        <a class="nav-link py-1" href="pi.php">PI</a>
        <a class="nav-link py-1" href="pow.php">POW</a>
        <a class="nav-link py-1" href="power.php">POWER</a>
        <a class="nav-link py-1" href="radians.php">RADIANS</a>
        <a class="nav-link py-1" href="rand.php">RAND</a>
        <a class="nav-link py-1" href="round.php">ROUND</a>
        <a class="nav-link py-1" href="sign.php">SIGN</a>
        <a class="nav-link py-1" href="sin.php">SIN</a>
        <a class="nav-link py-1" href="sqrt.php">SQRT</a>
        <a class="nav-link py-1" href="sum.php">SUM</a>
        <a class="nav-link py-1" href="tan.php">TAN</a>
        <a class="nav-link py-1" href="truncate.php">TRUNCATE</a>
    </div>
