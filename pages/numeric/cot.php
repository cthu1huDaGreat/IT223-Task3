...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>COT Function</h2>
    <h3>Description</h3>
    <p>The <code>COT()</code> function returns the cotangent of a number.</p>
    <h3>Syntax</h3>
    <pre><code>COT(number)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>The cotangent of the specified number.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Salary, COT(Salary) AS result FROM employee LIMIT 20";
