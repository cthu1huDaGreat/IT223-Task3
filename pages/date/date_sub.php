  ...
  <a class="nav-link py-1" href="../string/upper.php">UPPER</a>
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-calendar-event me-2'></i>DATE_SUB Function</h2>
        <h3>Description</h3>
        <p>MySQL date/time function for date processing and manipulation.</p>
        <h3>Syntax</h3>
        <pre><code>DATE_SUB(date, INTERVAL value unit)</code></pre>
        <h3>Returns</h3>
        <ul style="color: #e6eef3;"><li>Date/time value based on function logic</li></ul>
      </div>
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; $result = $conn->query("SELECT NOW() as result LIMIT 1"); $row = $result->fetch_assoc(); echo "<tr><td><code>" . htmlspecialchars($row["result"]) . "</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
