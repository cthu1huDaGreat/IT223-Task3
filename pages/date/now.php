...
<body>
  ...
  <a class="nav-link py-1" href="/IT223-task3/pages/string/upper.php">UPPER</a>
     ...
     <div class="collapse ps-3" id="dateFunctions" data-bs-parent="#sidebar">
        <a class="nav-link py-1" href="adddate.php">ADDDATE</a>
        <a class="nav-link py-1" href="addtime.php">ADDTIME</a>
        <a class="nav-link py-1" href="curdate.php">CURDATE</a>
        <a class="nav-link py-1" href="current_date.php">CURRENT_DATE</a>
        <a class="nav-link py-1" href="current_time.php">CURRENT_TIME</a>
        <a class="nav-link py-1" href="current_timestamp.php">CURRENT_TIMESTAMP</a>
        <a class="nav-link py-1" href="curtime.php">CURTIME</a>
        <a class="nav-link py-1" href="date.php">DATE</a>
        <a class="nav-link py-1" href="datediff.php">DATEDIFF</a>
        <a class="nav-link py-1" href="date_add.php">DATE_ADD</a>
        <a class="nav-link py-1" href="date_format.php">DATE_FORMAT</a>
        <a class="nav-link py-1" href="date_sub.php">DATE_SUB</a>
        <a class="nav-link py-1" href="day.php">DAY</a>
        <a class="nav-link py-1" href="dayname.php">DAYNAME</a>
        <a class="nav-link py-1" href="dayofmonth.php">DAYOFMONTH</a>
        <a class="nav-link py-1" href="dayofweek.php">DAYOFWEEK</a>
        <a class="nav-link py-1" href="dayofyear.php">DAYOFYEAR</a>
        <a class="nav-link py-1" href="extract.php">EXTRACT</a>
        <a class="nav-link py-1" href="from_days.php">FROM_DAYS</a>
        <a class="nav-link py-1" href="hour.php">HOUR</a>
        <a class="nav-link py-1" href="last_day.php">LAST_DAY</a>
        <a class="nav-link py-1" href="localtime.php">LOCALTIME</a>
        <a class="nav-link py-1" href="localtimestamp.php">LOCALTIMESTAMP</a>
        <a class="nav-link py-1" href="makedate.php">MAKEDATE</a>
        <a class="nav-link py-1" href="maketime.php">MAKETIME</a>
        <a class="nav-link py-1" href="microsecond.php">MICROSECOND</a>
        <a class="nav-link py-1" href="minute.php">MINUTE</a>
        <a class="nav-link py-1" href="month.php">MONTH</a>
        <a class="nav-link py-1" href="monthname.php">MONTHNAME</a>
        <a class="nav-link py-1" href="now.php">NOW</a>
        <a class="nav-link py-1" href="period_add.php">PERIOD_ADD</a>
        <a class="nav-link py-1" href="period_diff.php">PERIOD_DIFF</a>
        <a class="nav-link py-1" href="quarter.php">QUARTER</a>
        <a class="nav-link py-1" href="second.php">SECOND</a>
        <a class="nav-link py-1" href="sec_to_time.php">SEC_TO_TIME</a>
        <a class="nav-link py-1" href="str_to_date.php">STR_TO_DATE</a>
        <a class="nav-link py-1" href="subdate.php">SUBDATE</a>
        <a class="nav-link py-1" href="subtime.php">SUBTIME</a>
        <a class="nav-link py-1" href="sysdate.php">SYSDATE</a>
        <a class="nav-link py-1" href="time.php">TIME</a>
        <a class="nav-link py-1" href="time_format.php">TIME_FORMAT</a>
        <a class="nav-link py-1" href="time_to_sec.php">TIME_TO_SEC</a>
        <a class="nav-link py-1" href="timediff.php">TIMEDIFF</a>
        <a class="nav-link py-1" href="timestamp.php">TIMESTAMP</a>
        <a class="nav-link py-1" href="to_days.php">TO_DAYS</a>
        <a class="nav-link py-1" href="week.php">WEEK</a>
        <a class="nav-link py-1" href="weekday.php">WEEKDAY</a>
        <a class="nav-link py-1" href="weekofyear.php">WEEKOFYEAR</a>
        <a class="nav-link py-1" href="year.php">YEAR</a>
        <a class="nav-link py-1" href="yearweek.php">YEARWEEK</a>
    </div>
      ...
      <a class="nav-link d-flex justify-content-between align-items-center"
        ...
        <div class="collapse ps-3" id="advancedFunctions" data-bs-parent="#sidebar">
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/bin.php">BIN</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/binary.php">BINARY</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/case.php">CASE</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/cast.php">CAST</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/coalesce.php">COALESCE</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/connection_id.php">CONNECTION_ID</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/conv.php">CONV</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/convert.php">CONVERT</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/current_user.php">CURRENT_USER</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/database.php">DATABASE</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/if.php">IF</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/ifnull.php">IFNULL</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/isnull.php">ISNULL</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/last_insert_id.php">LAST_INSERT_ID</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/nullif.php">NULLIF</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/session_user.php">SESSION_USER</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/system_user.php">SYSTEM_USER</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/user.php">USER</a>
            <a class="nav-link py-1" href="/IT223-task3/pages/advanced/version.php">VERSION</a>
        </div>
