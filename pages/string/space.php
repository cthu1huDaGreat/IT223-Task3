...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>SPACE Function</h2>
    <h3>Description</h3>
    <p>The <code>SPACE()</code> function returns a string of spaces with a specified length.</p>
    <h3>Syntax</h3>
    <pre><code>SPACE(number_of_spaces)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A string of the specified number of space characters.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, SPACE(2) AS result FROM employee LIMIT 20";
