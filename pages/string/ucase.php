...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>UCASE Function</h2>
    <h3>Description</h3>
    <p>The <code>UCASE()</code> function converts a string to uppercase.</p>
    <h3>Syntax</h3>
    <pre><code>UCASE(string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A string in uppercase.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, UCASE(Name) AS result FROM employee LIMIT 20";
