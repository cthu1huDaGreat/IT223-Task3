...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>LCASE Function</h2>
    <h3>Description</h3>
    <p>The <code>LCASE()</code> function converts a string to lowercase.</p>
    <h3>Syntax</h3>
    <pre><code>LCASE(string)</code></pre>
    <h3>Returns</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, LCASE(Name) AS result FROM employee LIMIT 20";
