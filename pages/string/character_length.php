...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>CHARACTER_LENGTH Function</h2>
    <h3>Description</h3>
    <p>The <code>CHARACTER_LENGTH()</code> function returns the length of a string measured in characters.</p>
    <h3>Syntax</h3>
    <pre><code>CHARACTER_LENGTH(string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>Integer representing the number of characters in the string</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, CHARACTER_LENGTH(Name) AS char_length FROM employee LIMIT 20";
              ...
              if ($result) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td><code>" . htmlspecialchars($row['char_length']) . "</code></td>";
                  echo "</tr>";
                }
                $result->free();
              } else {
