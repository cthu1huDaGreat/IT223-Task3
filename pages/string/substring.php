...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>SUBSTRING Function</h2>
    <h3>Description</h3>
    <p>The <code>SUBSTRING()</code> function extracts a substring from a string.</p>
    <h3>Syntax</h3>
    <pre><code>SUBSTRING(string, start_position, length)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A substring of the specified length starting from the given position.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, SUBSTRING(Name, 1, 3) AS result FROM employee LIMIT 20";
