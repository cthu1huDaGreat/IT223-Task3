...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>LENGTH Function</h2>
    <h3>Description</h3>
    <p>The <code>LENGTH()</code> function returns the length of a string in bytes.</p>
    <h3>Syntax</h3>
    <pre><code>LENGTH(string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>Integer representing the length of the string in bytes</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, LENGTH(Name) AS result FROM employee LIMIT 20";
