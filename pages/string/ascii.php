...
<body>
  ...
  <a class="nav-link py-1" href="ascii.php">ASCII</a>
  <a class="nav-link py-1" href="char_length.php">CHAR_LENGTH</a>
  <a class="nav-link py-1" href="character_length.php">CHARACTER_LENGTH</a>
  <a class="nav-link py-1" href="concat.php">CONCAT</a>
  <a class="nav-link py-1" href="concat_ws.php">CONCAT_WS</a>
  <a class="nav-link py-1" href="field.php">FIELD</a>
  <a class="nav-link py-1" href="find_in_set.php">FIND_IN_SET</a>
  <a class="nav-link py-1" href="format.php">FORMAT</a>
  <a class="nav-link py-1" href="insert.php">INSERT</a>
  <a class="nav-link py-1" href="instr.php">INSTR</a>
  <a class="nav-link py-1" href="lcase.php">LCASE</a>
  <a class="nav-link py-1" href="left.php">LEFT</a>
  <a class="nav-link py-1" href="length.php">LENGTH</a>
  <a class="nav-link py-1" href="locate.php">LOCATE</a>
  <a class="nav-link py-1" href="lower.php">LOWER</a>
  <a class="nav-link py-1" href="lpad.php">LPAD</a>
  <a class="nav-link py-1" href="ltrim.php">LTRIM</a>
  <a class="nav-link py-1" href="mid.php">MID</a>
  <a class="nav-link py-1" href="position.php">POSITION</a>
  <a class="nav-link py-1" href="repeat.php">REPEAT</a>
  <a class="nav-link py-1" href="replace.php">REPLACE</a>
  <a class="nav-link py-1" href="reverse.php">REVERSE</a>
  <a class="nav-link py-1" href="right.php">RIGHT</a>
  <a class="nav-link py-1" href="rpad.php">RPAD</a>
  <a class="nav-link py-1" href="rtrim.php">RTRIM</a>
  <a class="nav-link py-1" href="space.php">SPACE</a>
  <a class="nav-link py-1" href="strcmp.php">STRCMP</a>
  <a class="nav-link py-1" href="substr.php">SUBSTR</a>
  <a class="nav-link py-1" href="substring.php">SUBSTRING</a>
  <a class="nav-link py-1" href="substring_index.php">SUBSTRING_INDEX</a>
  <a class="nav-link py-1" href="trim.php">TRIM</a>
  <a class="nav-link py-1" href="ucase.php">UCASE</a>
  <a class="nav-link py-1" href="upper.php">UPPER</a>
</div>
