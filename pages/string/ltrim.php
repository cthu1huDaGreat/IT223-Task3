...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>LTRIM Function</h2>
    <h3>Description</h3>
    <p>The <code>LTRIM()</code> function removes leading spaces from a string.</p>
    <h3>Syntax</h3>
    <pre><code>LTRIM(string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>String with leading spaces removed</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, LTRIM(Name) AS result FROM employee LIMIT 20";
