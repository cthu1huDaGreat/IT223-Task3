...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>LEFT Function</h2>
    <h3>Description</h3>
    <p>The <code>LEFT()</code> function returns a specified number of characters from the left side of a string.</p>
    <h3>Syntax</h3>
    <pre><code>LEFT(string, length)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>String containing the specified number of characters from the left side of the input string</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, LEFT(Name, 3) AS result FROM employee LIMIT 20";
