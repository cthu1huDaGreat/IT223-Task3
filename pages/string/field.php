...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>FIELD Function</h2>
    <h3>Description</h3>
    <p>The <code>FIELD()</code> function returns the index (position) of a string within a list of strings.</p>
    <h3>Syntax</h3>
    <pre><code>FIELD(string, string1, string2, ...)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>An integer representing the position of the first occurrence of <code>string</code> in the list of strings, or 0 if not found.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, FIELD('Cruz', 'Jaun', 'Dela', 'Cruz') AS field_result FROM employee WHERE ID = 2 ";
              ...
              if ($result) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td><code>" . htmlspecialchars($row['field_result']) . "</code></td>";
                  echo "</tr>";
                }
                $result->free();
              } else {
