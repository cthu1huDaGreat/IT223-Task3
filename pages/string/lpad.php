...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>LPAD Function</h2>
    <h3>Description</h3>
    <p>The <code>LPAD()</code> function pads a string on the left with a specified character to a given length.</p>
    <h3>Syntax</h3>
    <pre><code>LPAD(string, length, pad_string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A string padded with the specified character on the left to the given length</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, LPAD(Name, 9, '0') AS result FROM employee LIMIT 20";
