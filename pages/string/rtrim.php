...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>RTRIM Function</h2>
    <h3>Description</h3>
    <p>The <code>RTRIM()</code> function removes trailing spaces from a string.</p>
    <h3>Syntax</h3>
    <pre><code>RTRIM(string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A string with trailing spaces removed</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, RTRIM(Name) AS result FROM employee LIMIT 20";
