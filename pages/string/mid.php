...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>MID Function</h2>
    <h3>Description</h3>
    <p>The <code>MID()</code> function extracts a substring from a string, starting at a specified position and with a specified length.</p>
    <h3>Syntax</h3>
    <pre><code>MID(string, start_position, length)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>Substring of the original string</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, MID(Name, 2, 3) AS result FROM employee LIMIT 20";
