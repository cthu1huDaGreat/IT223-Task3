...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>RPAD Function</h2>
    <h3>Description</h3>
    <p>The <code>RPAD()</code> function right-pads a string to a specified length with a specified padding character.</p>
    <h3>Syntax</h3>
    <pre><code>RPAD(string, length, pad_string)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>String with the specified padding applied</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, RPAD(Name, 12, '*') AS result FROM employee LIMIT 20";
