...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>SUBSTRING_INDEX Function</h2>
    <h3>Description</h3>
    <p>The <code>SUBSTRING_INDEX()</code> function returns a substring from a string before a specified number of occurrences of a delimiter.</p>
    <h3>Syntax</h3>
    <pre><code>SUBSTRING_INDEX(string, delimiter, count)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A substring of the original string before the specified number of occurrences of the delimiter.</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, SUBSTRING_INDEX(Name, ' ', 1) AS result FROM employee LIMIT 20";
