...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>LOCATE Function</h2>
    <h3>Description</h3>
    <p>The <code>LOCATE()</code> function returns the position of a substring within a string.</p>
    <h3>Syntax</h3>
    <pre><code>LOCATE(substring, string, position)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>Integer representing the position of the substring within the string</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, LOCATE('a', Name) AS result FROM employee LIMIT 20";
