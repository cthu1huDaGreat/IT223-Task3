...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>UPPER Function</h2>
    <h3>Description</h3>
    <p>The <code>UPPER()</code> function converts a string to uppercase.</p>
    <h3>Syntax</h3>
    <pre><code>UPPER(string)</code></pre>
    <h3>Returns</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, UPPER(Name) AS result FROM employee LIMIT 20";
