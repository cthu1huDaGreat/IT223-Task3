...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>RIGHT Function</h2>
    <h3>Description</h3>
    <p>The <code>RIGHT()</code> function returns a specified number of characters from the right side of a string.</p>
    <h3>Syntax</h3>
    <pre><code>RIGHT(string, length)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A new string with the specified number of characters from the right side of the original string</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      <thead>
        <tr>
          <th>Name</th>
          <th>Rightmost 3 Characters</th>
        </tr>
      </thead>
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, RIGHT(Name, 3) AS result FROM employee LIMIT 20";
