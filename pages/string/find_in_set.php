...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>FIND_IN_SET Function</h2>
    <h3>Description</h3>
    <p>The <code>FIND_IN_SET()</code> function returns the position of a string within a comma-separated list of strings.</p>
    <h3>Syntax</h3>
    <pre><code>FIND_IN_SET(string, string_list)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>Integer representing the position of the string in the list (1-indexed), or 0 if not found</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, FIND_IN_SET('Claire', 'Angel,Claire,David') AS result FROM employee LIMIT 1";
