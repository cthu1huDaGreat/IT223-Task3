...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i></i>CHAR_LENGTH Function</h2>
    <h3>Description</h3>
    <p>The <code>CHAR_LENGTH()</code> function returns the length of a string measured in characters.</p>
    <h3>Syntax</h3>
    <pre><code>CHAR_LENGTH(string)</code></pre>
    <h3>Returns</h3>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Name, Department, CHAR_LENGTH(Name) AS char_length FROM employee LIMIT 20";
