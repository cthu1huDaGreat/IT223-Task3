...
<div class="page-content">
  <div class="function-card">
    <h2><i class="bi bi-type me-2"></i>FORMAT Function</h2>
    <h3>Description</h3>
    <p>The <code>FORMAT()</code> function formats a number to a specified number of decimal places and adds thousands separators.</p>
    <h3>Syntax</h3>
    <pre><code>FORMAT(number, decimals)</code></pre>
    <h3>Returns</h3>
    <ul style="color: #e6eef3;">
      <li>A formatted string representation of the number</li>
    </ul>
  </div>
  ...
  <div class="function-card">
    ...
    <table class="table example-table">
      ...
      <tbody>
        <?php
          include "../../config.php";
              $sql = "SELECT ID, Salary, FORMAT(Salary, 2) AS formatted_salary FROM employee LIMIT 20";
              ...
              if ($result) {
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td><code>" . htmlspecialchars($row['formatted_salary']) . "</code></td>";
                  echo "</tr>";
                }
                $result->free();
              } else {
