  ...
  <a class="nav-link py-1" href="../string/upper.php">UPPER</a>
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-gear me-2'></i>LAST_INSERT_ID Function</h2>
        <h3>Description</h3>
        <p>Advanced MySQL function for data processing and manipulation.</p>
        <h3>Syntax</h3>
        <pre><code>LAST_INSERT_ID()</code></pre>
        <h3>Returns</h3>
        <ul style="color: #e6eef3;"><li>Result based on function logic</li></ul>
      </div>
      <div class="function-card">
        <h3>Database Examples</h3>
        <table class="table example-table">
          <thead><tr><th>Function Result</th></tr></thead>
          <tbody>
            <?php include "../../config.php"; echo "<tr><td><code> last insert id.Groups[0].Value.ToUpper() ast last insert id.Groups[0].Value.ToUpper() nsert last insert id.Groups[0].Value.ToUpper() d executed</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
