  ...
  <a class="nav-link py-1" href="../string/upper.php">UPPER</a>
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-gear me-2'></i>CURRENT_USER Function</h2>
        <h3>Description</h3>
        <p>Advanced MySQL function for data processing and manipulation.</p>
        <h3>Syntax</h3>
        <pre><code>CURRENT_USER()</code></pre>
        <h3>Returns</h3>
      ...
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; echo "<tr><td><code> current user.Groups[0].Value.ToUpper() urrent current user.Groups[0].Value.ToUpper() ser executed</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
