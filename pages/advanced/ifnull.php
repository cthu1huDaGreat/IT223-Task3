  ...
  <a class="nav-link py-1" href="../string/upper.php">UPPER</a>
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-gear me-2'></i>IFNULL Function</h2>
        <h3>Description</h3>
        <p>Advanced MySQL function for data processing and manipulation.</p>
        <h3>Syntax</h3>
        <pre><code>IFNULL(expr1, expr2)</code></pre>
        <h3>Returns</h3>
      ...
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; echo "<tr><td><code> ifnull.Groups[0].Value.ToUpper() fnull executed</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
