  ...
  <a class="nav-link py-1" href="../string/upper.php">UPPER</a>
    ...
    <div class="container-fluid p-5">
      <div class="function-card">
        <h2><i class='bi bi-gear me-2'></i>VERSION Function</h2>
        <h3>Description</h3>
      ...
      <div class="function-card">
        ...
        <table class="table example-table">
          ...
          <tbody>
            <?php include "../../config.php"; echo "<tr><td><code> version.Groups[0].Value.ToUpper() ersion executed</code></td></tr>"; $conn->close(); ?>
          </tbody>
        </table>
      </div>
    </div>
